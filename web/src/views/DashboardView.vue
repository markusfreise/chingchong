  ...
  <div class="page-container">
    ...
    <div class="dashboard-stats">
      ...
      <div class="stat-card">
        ...
        <div class="stat-content">
          <span class="stat-label">Billable today</span>
    ...
    <div v-if="todayByProject.length" class="card">
      <div class="card-header">
        <h2 class="heading-3">Today by project</h2>
      </div>
      <div class="card-body">
    ...
    <div class="card dashboard-recent">
      <div class="card-header">
        <h2 class="heading-3">Recent entries</h2>
      </div>
      <div v-if="todayEntries.length === 0" class="empty-state">
        <ClockIcon class="empty-state-icon" />
        <p class="empty-state-text">No entries tracked today. Start a timer!</p>
      </div>
